...
int main(void) {
    ...
    0x1D, 0x83, 0x6E, 0x88, 0x9E, 0x46, 0x25, 0x9B, 0xCD, 0x1C, 0xCD, 0x2B, 0x36, 0x95, 0x83, 0xC5,
    0xB4, 0x7C, 0xFB, 0xB9, 0x19, 0xEC, 0x2B, 0x72
  };
   ...
   r = mayo2_crypto_sign_open(sma, m, mlen, pk);
    ...
    // Print the result
    printf("Time taken for verify: %f seconds\n", cpu_time_used);

    if(r == 0){
        printf("\n[1]. Mayo2 Signature Verified\n");
    }
    else{
